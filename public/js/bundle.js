...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"shortify.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkAvailability = exports.deletify = exports.shortify = void 0;
...
var shortify = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, slug, isPrivate) {
    var post;
  ...
  return function shortify(_x, _x2, _x3) {
...
var deletify = /*#__PURE__*/function () {
  ...
  return function deletify(_x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deletify = deletify;
...
var checkAvailability = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/url/checkSlug/".concat(slug)
            });

          case 3:
            res = _context3.sent;
            return _context3.abrupt("return", res.data.message);
  ...
  return function checkAvailability(_x5) {
...
var _shortify = require("./shortify");
...
var slugUrls = document.querySelectorAll('.slugUrl');
var deleteBtns = document.querySelectorAll('.deleteBtn');
var checkBtn = document.getElementById('check-link-availability');
...
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    var isPrivate = document.querySelector('.active').childNodes[1].value === 'private' ? true : false;
    (0, _shortify.shortify)(url, slug, isPrivate);
  });
}

if (slugUrls) {
  slugUrls.forEach(function (slugUrl) {
    slugUrl.addEventListener('click', function () {
      window.setTimeout(function () {
        location.assign('/');
      }, 500);
    });
...
if (deleteBtns) {
  deleteBtns.forEach(function (deleteBtn) {
    deleteBtn.addEventListener('click', function (e) {
      (0, _shortify.deletify)(e.target.parentElement.parentElement.parentElement.parentElement.dataset.id);
    });
  });
}

if (checkBtn) {
  checkBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var slug, isAvailable, messageBox;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _shortify.checkAvailability)(slug);

          case 4:
            isAvailable = _context.sent;
            messageBox = document.getElementById('link-availability-status');
